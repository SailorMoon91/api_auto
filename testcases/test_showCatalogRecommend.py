...
def test_showCatalogRecommend_success(base_url):
    r = showCatalogRecommend(base_url, "f5fecedac6e0469d98f475c60084c0d1", "86cd9e3e0fa440b9866d7b89021b8c59")
    print(r.text)
...
def test_showCatalogRecommend_fail(base_url,test_input,expected):
    r = showCatalogRecommend(base_url, "f5fecedac6e0469d98f475c60084c0d1", test_input)
    print(r.text)
